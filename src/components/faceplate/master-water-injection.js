          ...
          <div className="wrap-well">
            ...
            <div className="wrapper-bottom">
              ...
              <div className="d-flex align-items-end">
                ...
                <img
                  className="pcv-bottom-side"
                  id="sdv1013"
                  src={props.sdvTwoStatus === 1 ? pcv : pcvstop}
                  alt=""
                />
              ...
              <img
                className="pcv-from-box-to-safety"
                id="sdv1012"
                src={props.sdvOneStatus === 1 ? pcv : pcvstop}
                alt=""
              />
              ...
              <div className="d-flex flex-column bg-light p-1 border border-primary pt-3001">
                <span className="txt-pt-3001 p-1 text-center bg-dark fw-bolder text-white">
                  {props.ptTitle}
                </span>
                <span className="indicator-pt-3001 p-1 text-center fw-bold">
                  {props.ptStatus ? props.ptStatus : "####"} PSI
                </span>
              </div>
              {/* SDV-1013 */}
              <div className="d-flex flex-column bg-light p-1 border border-primary sdv-1013">
                <span className="txt-sdv-1013 p-1 text-center bg-dark fw-bolder text-white">
                  {props.sdvTwoTitle}
                </span>
                <span
                  className={
                    "indicator-sdv-1013 p-1 text-center fw-bold " +
                    (props.sdvTwoStatus === 1 ? "bg-normal" : "bg-error")
                  }
                >
                  {props.sdvTwoStatus === 1 ? "OPEN" : "CLOSE"}
                </span>
              </div>
              {/* SDV-1012 */}
              <div className="d-flex flex-column bg-light p-1 border border-primary sdv-1012">
                <span className="txt-sdv-1012 p-1 text-center bg-dark fw-bolder text-white">
                  {props.sdvOneTitle}
                </span>
                <span
                  className={
                    "indicator-sdv-1013 p-1 text-center fw-bold " +
                    (props.sdvOneStatus === 1 ? "bg-normal" : "bg-error")
                  }
                >
                  {props.sdvOneStatus === 1 ? "OPEN" : "CLOSE"}
                </span>
              </div>
