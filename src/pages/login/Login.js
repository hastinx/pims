      ...
      <section>
        <div className="container mt-5 px-4 py-5 px-md-5 text-center text-lg-start">
          ...
          <div className="row gx-lg-5 align-items-center mb-5">
            <div
              className="col-lg-12 mb-5 mb-lg-0 intro d-flex justify-content-between"
              style={{ zIndex: 10 }}
            >
              <h1
              ...
              <h1 className="mx-2 display-5 fw-bold ls-tight">
                <span style={{ color: "hsl(354, 85%, 52%, 1)" }}>PHE TEJ</span>
              </h1>
            </div>
          </div>
                ...
                <div className="card-body px-4 py-5 px-md-5">
                  <form className="mb-3" onSubmit={login}>
                    ...
                    <div className="input-group mb-4 border border-primary">
                      ...
                      <span
                        className="input-group-text bg-white border-0 togglr-password"
                  ...
                  <div className="mb-4" id="alert"></div>
